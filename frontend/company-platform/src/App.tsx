...
const navigation: NavItem[] = [
  ...
  { label: 'People & Access', icon: 'people' },
  { label: 'Workspaces', icon: 'workspaces' },
  { label: 'Data Visibility', icon: 'visibility' },
      ...
      <main className="main-area">
        <header className="topbar">
          ...
          <div className="topbar-actions">
            ...
            <button className="avatar" aria-label="Account" onClick={() => setMenuOpen(!menuOpen)}>CA</button>
            {menuOpen && <div className="user-popover"><strong>Company Administrator</strong><span>Company Platform</span><button onClick={() => setMenuOpen(false)}>Close</button></div>}
          </div>
        </header>
