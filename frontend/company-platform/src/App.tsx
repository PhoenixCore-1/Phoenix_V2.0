...
function App() {
  ...
  useEffect(() => { void loadCompany().then(setCompany).catch(error => setCompanyError(error instanceof Error ? error.message : 'Unable to load company identity.')) }, [])
